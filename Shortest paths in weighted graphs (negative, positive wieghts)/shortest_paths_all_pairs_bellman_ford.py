...
In my experiment, this program took around 4-5 minitues to compute shortest paths in "sample_3.txt" input.
...
def all_pairs_bellman_ford(n, edges):
    ...
    def bellman_ford_source_to_all(source):
        """ This function computes shortest paths from a single source using Bellman-Ford algorithm. """
        nonlocal n, edges
        nonlocal dist_matrix, path_matrix
